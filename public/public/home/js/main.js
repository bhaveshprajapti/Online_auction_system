...
Copyright (c) 2017
[Custom JS Script]
Theme Name : App-Presentation Landing Page
Version    : 1.0
Author     : UiSuMo Team
...
$(document).ready(function() {
    ...
    if ($(".screenshot-method").length) {
        $(".screenshot-method").owlCarousel({
            items: 2,
            autoplay: true,
            nav: false,
            dots: false,
    ...
    //Patners Section
    if ($(".screenshot-patner").length) {
        $(".screenshot-patner").owlCarousel({
            items: 5,
            autoplay: true,
            nav: false,
            dots: false,
    ...
    if ($(".screenshot-similar-product").length) {
        $(".screenshot-similar-product").owlCarousel({
            items: 4,
            autoplay: true,
            nav: false,
            dots: true,
